            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tanggal_izin') is-invalid @enderror" id="tanggal_izin" placeholder="Tanggal Izin" name="tanggal_izin" value="{{old('tanggal_izin')}}">
                        @error('tanggal_izin') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="akhir_izin">Akhir Izin</label>
                        <input type="text" class="form-control @error('akhir_izin') is-invalid @enderror" id="akhir_izin" placeholder="Akhir Izin" name="akhir_izin" value="{{old('akhir_izin')}}">
