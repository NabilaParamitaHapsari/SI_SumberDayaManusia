...
@section('content_header')
    <h1 class="m-0 text-dark">Tambah Absensi</h1>
@stop
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('shift') is-invalid @enderror" id="shift" placeholder="Shift" name="shift" value="{{old('shift')}}">
