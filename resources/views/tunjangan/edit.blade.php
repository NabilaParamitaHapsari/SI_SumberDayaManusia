...
@section('title', 'Edit Data Pengembangan')

@section('content_header')
    <h1 class="m-0 text-dark">Edit Data Pengembangan</h1>
@stop
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" placeholder="Tanggal" name="tanggal" value="{{$tunjangan->tanggal ?? old('tanggal')}}">
